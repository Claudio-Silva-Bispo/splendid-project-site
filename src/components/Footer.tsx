...
export default function Footer() {
  return (
	...
	<div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
		<div className="hidden lg:grid lg:w-1/3">
			<a rel="noopener noreferrer" href="/" className="flex justify-center space-x-3 lg:justify-center">
				<img src="/assets/Logo/imagem-logo-oficial.png" alt="Logo da empresa" className="w-36 h-36" />
			...
			<div className="space-y-3">
				...
				<div className="flex justify-start space-x-3">
					<a rel="noopener noreferrer" href="https://www.facebook.com/profile.php?id=100083121271391&mibextid=ZbWKwL" target="_blank" title="Facebook" className="flex items-center p-1">
						<svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 32 32" className="w-12 h-12 fill-current">
							<path d="M32 16c0-8.839-7.167-16-16-16-8.839 0-16 7.161-16 16 0 7.984 5.849 14.604 13.5 15.803v-11.177h-4.063v-4.625h4.063v-3.527c0-4.009 2.385-6.223 6.041-6.223 1.751 0 3.584 0.312 3.584 0.312v3.937h-2.021c-1.984 0-2.604 1.235-2.604 2.5v3h4.437l-0.713 4.625h-3.724v11.177c7.645-1.199 13.5-7.819 13.5-15.803z"></path>
						</svg>
					</a>
					
					<a rel="noopener noreferrer" href="https://www.instagram.com/splendidcleaningserv?igsh=eWJiZHIybXFidGU4" target="_blank" title="Instagram" className="flex items-center p-1">
						<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" fill="currentColor" className="w-12 h-12 fill-current">
	...
	<div className="py-6 text-sm text-center text-gray-600">© 2024 Company Splendid Cleaning Service. All rights reserved.</div> 
