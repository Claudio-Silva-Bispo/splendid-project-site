		...
		<div className="grid text-xl gap-x-3 gap-y-8 lg:w-2/3 md:grid-cols-4 p-5 md:p-0">
			...
			<div className="space-y-3">
				...
				<div className="flex justify-start space-x-3">
					<a rel="noopener noreferrer" href="https://www.facebook.com/share/53WiZXAVYdNsHkqY/?mibextid=qi2Omg" target="_blank" title="Facebook" className="flex items-center p-1">
