...
export default function About() {
  return (
    <>
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "@type": "AboutPage",
              "name": "About Splendid Cleaning Service",
              "description": "Family-owned cleaning service in Seattle, Bellevue, and Tacoma. Professional, reliable, and eco-friendly cleaning solutions.",
              "url": "https://www.splendidcleaningserv.com/#about",
              "mainEntity": {
                "@type": "LocalBusiness",
                "name": "Splendid Cleaning Service",
                "description": "Founded by an entrepreneur dedicated to care and affection. We transform each house into a welcoming home with attention to every detail.",
                "address": {
                  "@type": "PostalAddress",
      ...
      <div className='bg-quarta' id="about">
        <div className="container p-0 min-w-full min-h-[70vh] bg-quarta grid grid-cols-1 justify-center items-center md:flex md:items-center md:justify-between">
          ...
          <div className="w-full flex flex-col justify-center text-gray-800 md:text-center lg:text-left lg:pl-8 p-6 lg:p-12">
            ...
            <h2 className="py-4 text-3xl lg:text-5xl leading-tight text-segunda">
              Founded by an entrepreneur dedicated to care and affection
            </h2>
            <p className="pb-6 text-xl md:text-2xl">
              Our company was born out of the desire to transform each house into a new and welcoming home, where every detail reflects love, care, and dedication. Serving Seattle, Bellevue, Tacoma, and surrounding areas with professional cleaning services.
            </p>
            
            {/* Badge de localização */}
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-segunda/10 w-fit">
              <span className="text-lg">📍</span>
              <span className="font-semibold text-sm text-segunda">
                Proudly serving Greater Seattle Area
              </span>
            </div>
          </div>
        ...
        <section className="bg-quarta text-gray-800">
          <div className="container max-w-xl p-6 py-12 mx-auto space-y-24 lg:px-8 lg:max-w-7xl">
            <div>
              ...
              <p className="max-w-3xl mx-auto mt-4 text-2xl md:text-center text-gray-600">
                Professional cleaning services in Seattle, Bellevue & Tacoma - We focus on the smallest details
              </p>
            </div>
                ...
                <div className="mt-12 space-y-12">
                  <div className="flex">
                    ...
                    <div className="ml-4">
                      ...
                      <p className="mt-2 text-gray-600">All our employees wear standardized uniforms, ensuring our company&apos;s identity and conveying professionalism throughout Seattle area.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex">
                    ...
                    <div className="ml-4">
                      ...
                      <p className="mt-2 text-gray-600">Our priority is to provide high-quality cleaning services, ensuring customer satisfaction in every project we undertake in Bellevue, Tacoma, and surrounding cities.</p>
                    </div>
                  </div>
        ...
        <div className="relative w-full flex flex-col gap-4 py- overflow-x-hidden">
          <div className='p-8 md:p-28'>
            <h3 className="text-2xl font-bold tracking-tight sm:text-3xl text-gray-900">
              See before and after photos of our cleaning services in Seattle, Bellevue & Tacoma
            </h3>
          ...
          <div className="flex gap-4 animate-marquee">
            <img className="h-60 aspect-video rounded-sm object-fill object-center bg-gray-500" src="/assets/Service/cozinha/20210201_131604.jpg" alt="Kitchen cleaning service Seattle - Splendid Cleaning" />
            <img className="h-60 aspect-video rounded-sm object-fill object-center bg-gray-500" src="/assets/Service/cozinha/20210201_131604.jpg" alt="Professional house cleaning Bellevue" />
            <img className="h-60 aspect-video rounded-sm object-fill object-center bg-gray-500" src="/assets/Service/cozinha/20200701_143913.jpg" alt="Deep cleaning service Tacoma" />
            <img className="h-60 aspect-video rounded-sm object-cover object-center bg-gray-500" src="/assets/Service/cozinha/20200701_162936.jpg" alt="Residential cleaning Seattle area" />
            <img className="h-60 aspect-video rounded-sm object-fill object-center bg-gray-500" src="/assets/Service/cozinha/20201125_151653.jpg" alt="Kitchen deep cleaning Bellevue" />
            <img className="h-60 aspect-video rounded-sm object-fill object-center bg-gray-500" src="/assets/Service/sala/20201217_123713.jpg" alt="Living room cleaning service" />
            <img className="h-60 aspect-video rounded-sm object-fill object-center bg-gray-500" src="/assets/Service/sala/IMG-20200204-WA0028.jpg" alt="Professional cleaning Tacoma" />
            <img className="h-60 aspect-video rounded-sm object-fill object-center bg-gray-500" src="/assets/Service/chao/20201125_152907.jpg" alt="Floor cleaning service Seattle" />
          </div>
        </div>
