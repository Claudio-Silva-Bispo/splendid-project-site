...
export default function FormQuote() {
  ...
  return (
    ...
    className='bg-primeira grid md:flex px-5 md:px-10 justify-center items-center min-h-[640px]'>
        ...
        <h1 className='text-6xl md:text-6xl tracking-tight text-[#FFFF] uppercase mt-20 md:mt-0'>Get Your Quote Today</h1>
        <p className='mt-5 mb-5 text-xl md:text-3xl text-white w-[100%]'>To schedule a cleaning service or request a quote, simply fill out the form.</p>
        <p className='mt-5 mb-5 text-xl md:text-3xl text-white w-[100%]'>Let us know the details of the service you need, whether it's for residential, commercial cleaning, or a special event.</p>
        <p className='mt-5 mb-10 text-xl md:text-3xl text-white w-[100%]'>We are here to meet your needs and ensure the cleanliness and comfort you deserve.</p>
