    ...
    return(
        ...
        <footer className="footer bg-gray-200 text-base-content p-10 flex justify-around gap-10">
            ...
            <form className="flex flex-col">
                ...
                <fieldset className="form-control w-80 flex flex-col gap-5">
                ...
                <div>
                    <button rel="noopener noreferrer" className="px-8 py-3 text-lg font-semibold rounded bg-[rgb(229,51,47)] dark:text-gray-50">Inscreva-se</button>
                </div>
