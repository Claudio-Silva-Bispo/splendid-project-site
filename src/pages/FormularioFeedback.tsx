                        ...
                        <div className="flex flex-col max-w-xl p-8 shadow-sm rounded-xl lg:p-12 dark:bg-gray-50 dark:text-gray-800">
                            <div className="flex flex-col items-center w-full">
                                ...
                                <div className="flex flex-col items-center py-6 space-y-3">
                                    ...
                                    <div className="flex space-x-3">
                                        <button type="button" title="Rate 1 stars" aria-label="Rate 1 stars">
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-10 h-10 text-yellow-300">
                                ...
                                <div className="flex flex-col w-full">
                                    <textarea rows={5} placeholder="Mensagem..." className="p-4 rounded-md resize-none dark:text-gray-800 "></textarea>
                                    <button type="button" className="py-4 my-8 font-semibold rounded-md dark:text-gray-50" style={{ backgroundColor: '#E5332F' }}>Deixe sua mensagem</button>
                                </div>
                            </div>
